...
export class RestService {
  // default ApiKey: 30b99eebbcd8bad62670dff478c45de9
  private baseUrl: string = `https://api.openweathermap.org/data/2.5/forecast?appid=${localStorage.getItem('apiKey') ? localStorage.getItem('apiKey') : '30b99eebbcd8bad62670dff478c45de9'}&lang=az&q=`
